...
doc = FreeCAD.newDocument("chamfer_model")
...
shape_17 = obj_16.Shape.makeChamfer(2.0, obj_16.Shape.Edges)
obj_18 = doc.addObject("Part::Feature", "Chamfer")
obj_18.Shape = shape_17

doc.recompute()

doc.saveAs(r"forge\output\chamfer_model.FCStd")

Import.export([obj_18], r"forge\output\chamfer_model.step")